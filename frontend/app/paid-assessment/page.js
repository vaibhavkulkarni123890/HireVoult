        ...
        <div className="glass-card" style={{ padding: 40 }}>
          ...
          <div style={{ background: 'rgba(245,158,11,0.1)', border: '1px solid rgba(245,158,11,0.3)', borderRadius: 12, padding: 16, marginBottom: 24 }}>
            <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#f59e0b', marginBottom: 4 }}>Note: Free Assessment Limit</div>
                <div style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
                  Each company gets <strong style={{ color: '#fff' }}>1 free assessment</strong> (JavaScript & Python only). To create more, please upgrade to a paid plan.
                </div>
              </div>
            </div>
          </div>
      {/* Utilized free assessment message (to be conditionally rendered in dashboard/navbar when user tries to create new role after using free assessment) */}
      {/*
